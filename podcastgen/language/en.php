...
$L_firstadminmsg = "This is possibly the first time you enter this page: you haven't changed your podcast details yet. You are reccommended to set a podcast title, description, your name, e-mail, etc...";
...
$L_max_upload_allowed = "Your server configuration allows to upload files up to";
$L_menu_admin = "Admin";
