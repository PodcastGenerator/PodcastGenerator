...
<body>
    <div class="container">
        ...
        <p>
        <?php
        echo _('We offer a tool which allows you to easily recover your password. However, the danger of this is that as long as this file is only, anyone can reset this password so this file shouldn\'t be online that long.');
        echo '<br>';
