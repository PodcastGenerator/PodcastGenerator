...
function backwards_3_1_to_3_2_8($absoluteurl)
{
    session_start();
    session_destroy();
    global $config;
    ...
    if (
        !(
            ...
            || $config['podcastgen_version'] == '3.2.4'
            || $config['podcastgen_version'] == '3.2.5'
            || $config['podcastgen_version'] == '3.2.6'
            || $config['podcastgen_version'] == '3.2.7'
        )
    ) {
        return;
    }
