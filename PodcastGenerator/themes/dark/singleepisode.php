...
echo '  <div class="card mb-5 mt-5 mt-lg-0">';
...
echo '  <div class="col bg-secondary text-white">';
echo '  <div class="card-body">';
echo '  <h4>' . $correctepisode["episode"]["titlePG"] . '</h4>';
echo '  <p><i class="fa fa-calendar" aria-hidden="true"></i> <small class="text-white">' . $correctepisode["episode"]["moddate"] . '</small></p>';
...
echo '  <a class="btn btn-outline-light btn-sm" href="media/' . $correctepisode["episode"]["filename"] . '">' . $download . '</a><br>';
if ($type != 'invalid') {
    echo '  <small style="font-size:65%" class="text-white">' . $filetype . ': ' . strtoupper(pathinfo($config["upload_dir"] . $correctepisode["episode"]["filename"], PATHINFO_EXTENSION)) . '
