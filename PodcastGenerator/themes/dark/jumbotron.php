    ...
    <div class="search-container" style="margin-bottom: 2rem;">
        <form action="index.php" class="form-inline">
            ...
            <div class="form-group" style="width: 20%;">
                <button type="submit" class="btn btn-secondary" style="width: 100%;"><div style="-webkit-transform: rotate(-45deg); -moz-transform: rotate(-45deg); -o-transform: rotate(-45deg); transform: rotate(-45deg);">&#9906;</div></button>
            </div>
        </form>
    </div>
</div>
