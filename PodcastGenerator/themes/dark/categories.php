        ...
        ?>
            <div class="col">
                <div class="list-group">
                    <a class="list-group-item list-group-item-action bg-secondary text-white" href="categories.php?cat=all"><?php echo _('All Episodes'); ?></a>
                    <?php
                    foreach ($categories_xml as $item) {
                        echo "<a class='list-group-item list-group-item-action bg-secondary text-white' href=\"categories.php?cat=" . $item->id . "\">" . $item->description . "</a>";
                    }
                    ?>
                </div>
            </div>
