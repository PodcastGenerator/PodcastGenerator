# Podcast Generator 3.2.6

Podcast Generator 3.2.6 is now available:

<https://github.com/PodcastGenerator/PodcastGenerator/releases/download/v3.2.6/PodcastGenerator-v3.2.6.zip>

This is a patch release for 3.2 containing a security fix and fixes for initial
website setup.
...
1. Download `PodcastGenerator-v3.2.6.zip` and extract to a local directory.
