...
Podcast Generator 3.2.7 is now available:

<https://github.com/PodcastGenerator/PodcastGenerator/releases/download/v3.2.7/PodcastGenerator-v3.2.7.zip>

This is a patch release for 3.2 containing security fixes.
...
1. Download `PodcastGenerator-v3.2.7.zip` and extract to a local directory.
...
Thanks to suorcd for the updated install docs. Also, thanks to everyone who
reported bugs and to our translators.
